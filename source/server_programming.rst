...
in this part are advanced and should be read after understanding the basics of
SensorBee and BQL.
...
`How to Write Go Code <https://golang.org/doc/code.html>`_ helps to understand
